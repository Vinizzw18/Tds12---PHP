...
<html lang="pt-br">
    ...
    <body>
                ...
                <div class="card mb-4 rounded-3 shadow-sw">
                    ...
                    <div class="card-body">
                        <form action="resultado.php" method="post">
                            ...
                            <input class="form-control" type="number" id="data" name="data1" step="0.01" required placeholder="Digite a data aqui..."/>
                            <br/>
        ...
        <center><img src="imagem/html.png" width = "190" height="520"></center>
    </body>
</html>